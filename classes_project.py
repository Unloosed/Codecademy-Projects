class Menu:
  ...
  def __repr__(self):
    self.representative_string = self.name + " menu available from " + str(self.start_time) + " to " + str(self.end_time)
...
class Franchise:
  ...
  def __repr__(self):
    self.representative_string = "This restaurant is located at " + self.address
    return self.representative_string
